        ...
        <div>
            <section className="text-gray-600 body-font">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <p className="mt-4 text-yelow">для студентов разных направлений подготовки</p>
                    ...
                    <Image className="object-cover object-center rounded" src="/assets/hero.svg" alt="hero" width={520} height={400} />
                    </div>
                </div>
            </section>
            <section>
