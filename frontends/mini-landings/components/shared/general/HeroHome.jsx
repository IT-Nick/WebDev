...
const HeroHome = () => {
  return (
    <div className="md:w-1/2 p-4 md:text-start text-center md:ml-10 md:mt-36">
      <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
        <div>
          Создавай <span className='bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-500'>своё</span> будущее 
        </div>
        <div>
