...
function TestimotalsSection() {
  const images = [
    "/assets/testimotals/2.svg",
    "/assets/testimotals/1.svg",
    "/assets/testimotals/3.svg",
    "/assets/testimotals/4.svg",
    "/assets/testimotals/5.svg",
  ];
    ...
    <div className="relative w-full h-auto mx-auto p-8">
      <div className="mx-auto max-w-3xl text-center">
        ...
        Медалисты VI сезона
          ...
          Хочешь быть среди них? Тогда начинай готовиться к VII сезону олимпиады.
          </p>
        </div>
...
export default TestimotalsSection;
