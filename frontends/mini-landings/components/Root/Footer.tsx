  ...
  <div className="max-w-3xl text-center px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      ...
      <a
        ...
        className="inline-block px-20 py-8 mt-8 text-xl font-bold text-white border border-white hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
      >
        Выбрать мероприятие
      </a>
    </div>
    ...
    >
      <nav aria-label="Footer Navigation - Support">
        <ul className="flex flex-wrap justify-center gap-4 text-xs">
          <li>
            <a href="https://mpei.ru" className="text-white transition hover:opacity-75">
