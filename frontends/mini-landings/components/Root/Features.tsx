...
<section className="">
  ...
  >
    ...
    <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      <a
        className="block bg-white rounded-xl border border-gray-200 p-8 transition hover:border-blue-500/10 hover:shadow-blue-800/10"
        href="/docs#комьюнити"
      >
        <svg
        ...
        <h2 className="mt-4 text-xl font-bold text-rose-500">Комьюнити</h2>
      ...
      >
        ...
        <h2 className="mt-4 text-xl font-bold text-rose-500">Менторство участников</h2>
      ...
      >
        ...
        <h2 className="mt-4 text-xl font-bold text-rose-600">Коворкинг</h2>
      ...
      >
        ...
        <h2 className="mt-4 text-xl font-bold text-rose-600">Без операционной работы</h2>
      ...
      >
        ...
        <h2 className="mt-4 text-xl font-bold text-rose-600">Пополнение резюме</h2>
      ...
      >
        ...
        <h2 className="mt-4 text-xl font-bold text-rose-600">Продвижение по карьере</h2>
